programa
{
	...
	funcao inicio()
	{
		...
		escreva("nroInicializado[0]: " + nroSolicitando[0] + "\n")
		escreva("nroInicializado[1]: " + nroSolicitando[1] + "\n")
		escreva("nroInicializado[2]: " + nroSolicitando[2] + "\n")
		escreva("nroInicializado[3]: " + nroSolicitando[3] + "\n")
		escreva("nroInicializado[4]: " + nroSolicitando[4])
